...
**Status:** VALIDATE ONLY. Research + written plan. **Do not build. Do not publish. Do not merge. Do not deploy production.**
...
**Next human action:** Nick reads this PR. If he wants a Build, he sets the EC to Build + Approved for Cursor and names a price SKU (A–D). Until then, stop.
