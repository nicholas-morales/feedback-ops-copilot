...
**Founding price:** $500, done in 48 hours, against a written acceptance table (same checks as `OFFER.md` in the repo). Optional **$199 same-day audit** credits in full toward the $500 build if you convert. Notion-only (your workspace, no n8n wiring) is $250.
