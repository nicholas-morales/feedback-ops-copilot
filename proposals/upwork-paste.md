...
**Founding price:** $350, done in 72 hours, against a written acceptance table (same checks as `OFFER.md` in the repo). Notion-only (your workspace, no n8n wiring) is $250.
