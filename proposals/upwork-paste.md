...
**Founding price:** $500, done in 48 hours, against a written acceptance table (same checks as `OFFER.md` / `docs/BUYER-ONE-PAGER.md` in the repo). Same-day audit is $199 and credits toward the $500 build. Notion-only (your workspace, no n8n wiring) is $250.
