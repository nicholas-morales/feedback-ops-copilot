...
**Founding offer:** [$500 / 48 hours](./OFFER.md) (or $250 Notion-only). Optional **$199 same-day audit** credits in full toward the $500 build. See [OFFER.md](./OFFER.md) for scope, exclusions, and measurable acceptance checks. One-page buyer sheet: [docs/BUYER-ONE-PAGER.md](./docs/BUYER-ONE-PAGER.md).
